...
all events into the specific storm events detailed in the documentation.
...
strm_data1 <- strm_data %>%
     ...
     mutate(EVTYPEFix = str_replace_all(
          ...
          c("^(NON|NO)?[ -]?(SEVERE|STRONG|MAJOR|MODERATE|LIGHT|HEAVY|HVY|EXCESSIVE|DENSE|DEEP|DAMAGING|MINOR|EXTREME) " = "",
            ...
            "MONTHLY SNOWFALL" = "HEAVY SNOWFALL",
            ...
            "WET(.*)" = "HEAVY RAIN",
            "WILDFIRES" = "WILDFIRE",
            "WINTER STORMITATION" = "WINTER STORMITATION"
            )
     ))
```
...
strm_data2 <- strm_data_tst[!(strm_data_tst$PROPDMGEXP == "2" |
                                strm_data_tst$PROPDMGEXP == "3" |
                                strm_data_tst$PROPDMGEXP == "4" |
                                strm_data_tst$PROPDMGEXP == "5" |
                                strm_data_tst$PROPDMGEXP == "6" |
                                strm_data_tst$PROPDMGEXP == "7" |
                                strm_data_tst$PROPDMGEXP == "-" |
                                strm_data_tst$PROPDMGEXP == "+" |
                                strm_data_tst$PROPDMGEXP == "H"
),]
...
barplot(propcrop_5$DMG_tot, main = "Total Dollars of Property and Crop Damages", 
        names.arg = propcrop_5$EVTYPEFix, cex.names = .75)
```
